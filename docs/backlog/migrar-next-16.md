...
> Historia enriquecida el 2026-09-16 a partir del análisis del cambio `actualizar-dependencias-seguras`. Estado: **lista para `/opsx:ff migrar-next-16`**. Prioridad: alta (alerta crítica de `next` abierta).
