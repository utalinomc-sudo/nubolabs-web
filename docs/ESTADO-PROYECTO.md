...
- Pendientes detectados en el bootstrap (perfil §11): elegir runner de tests, confirmar idioma de identificadores y política de PRs, y corregir `metadataBase` (`nubolabs.ai` → `nubolabs.cl`) en `app/layout.tsx`.
