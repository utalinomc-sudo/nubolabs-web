...
5. If the story lacks enough technical detail for autonomous implementation, provide an improved version that is clearer, more specific, and concise, aligned with step 4. Use the project technical context from `docs/` (`project-profile.md`, `*-standards.md`, `api-spec.yml`, `data-model.md`). Write the result in markdown, in the specs language defined in `docs/project-profile.md` §6.
