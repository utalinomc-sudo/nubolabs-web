    ...
    <section id="servicios" className="bg-surface-soft py-20">
      <div className="container-page">
        <div className="mb-10 text-center">
          <div className="mb-3 text-xs font-bold tracking-[2.5px] text-brand">SERVICIOS</div>
          <h2 className="text-[30px] font-extrabold tracking-[-1px] md:text-[34px]">
            Vendemos resultados, no herramientas
          </h2>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {services.map((s, i) => {
            ...
            return (
              <div key={s.title} className="rounded-[18px] border border-line bg-white p-7">
